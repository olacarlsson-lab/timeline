...
const DEFAULT_LABELS = {
    ...
    zoom3MonthsDays: '90',
    helpTitle: 'Om Timeline',
    aboutTitle: 'Vad är Timeline?',
    aboutText: 'Timeline är ett visuellt planeringsverktyg för att hantera projekt och händelser över tid. Perfekt för verksamhetsplanering, utställningsplanering, projektöversikter eller personlig planering.',
    featuresTitle: 'Funktioner',
    featuresList: '<li><strong>Projekt</strong> - Skapa projekt med start- och slutdatum, färgkodning, status och ansvarig</li><li><strong>Händelser</strong> - Lägg till händelser, fristående eller kopplade till projekt</li><li><strong>Områden</strong> - Organisera projekt i olika områden/kategorier</li><li><strong>Statusar</strong> - Definiera egna statusnivåer för att följa projektens framsteg</li><li><strong>Zoomning</strong> - Zooma in och ut för att se olika tidsperioder</li><li><strong>Filter</strong> - Filtrera vyn efter område och status</li>',
    tipsTitle: 'Tips',
    ...
    offlineText: 'Timeline är en PWA och kan installeras på din enhet. När den är installerad fungerar den även offline.',
    infoGotIt: 'Uppfattat',
    // Repeat
    repeatLabel: 'Upprepa',
...
const DEFAULT_LABELS_EN = {
    ...
    featuresList: '<li><strong>Projects</strong> - Create projects with start and end dates, color coding, status and responsible person</li><li><strong>Events</strong> - Add events, standalone or linked to projects</li><li><strong>Workstreams</strong> - Organize projects into different workstreams/categories</li><li><strong>Statuses</strong> - Define custom status levels to track project progress</li><li><strong>Zooming</strong> - Zoom in and out to see different time periods</li><li><strong>Filters</strong> - Filter the view by workstream and status</li>',
    tipsTitle: 'Tips',
